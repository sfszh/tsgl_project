...
public:
	...
	void draw(){
		...
		// emulate ofrect first, make compile pass
	// does it have to draw?
	void ofRect(float x, float y, float width, float height) {
		std::cout << "draw ofrect: " <<x<<", "<<y<<", "<<width<< ", "<< height << std::endl;
	}	
};
